...
*
**/
public class SelectVoByIdsIgnoreDeleteFlag extends AbstractMethod {

    private String sqlMethod = "selectVoByIdsIgnoreDeleteFlag";
    ...
    public MappedStatement injectMappedStatement(Class<?> mapperClass, Class<?> modelClass, TableInfo tableInfo) {
        ...
        return addSelectMappedStatementForOther(mapperClass, sqlMethod, sqlSource, InjectorUtils.voClass(mapperClass));
    }
}
